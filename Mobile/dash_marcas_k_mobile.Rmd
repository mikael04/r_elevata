...
## Corrigindo o path, como está adaptado pra geral, o caminho dos arquivos muda
marcas_icon_txt$iconUrl <- gsub('Icons/', '../Icons/', marcas_icon_txt$iconUrl)
...
```{r}
### Gráfico n4 - Valor financeiro de negócios em 2020  (por categoria)
n4
...
```{r}
### Gráfico n5 - Máquinas faturadas em 2020 (por categoria)
n5
