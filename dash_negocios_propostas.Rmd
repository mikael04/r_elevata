...
if (teste == F){
  ...
  rm(ng_ij_hist_ij_ven_ij_np_2020, fat_2020_mes, ng_ij_hist_ij_ven_total, negocio_ij_historico_ij_vendedor_total,
     fat_2019_mes, fat_2020_2019_2018_mes, fat_2020_mes_aux, ay, a, negocio_produto,
     ng_ij_hist_ij_ven_2020, ng_ij_hist_ij_ven_2020_fat, ng_ij_hist_ij_ven_ij_np_2019_fat,
     ng_ij_hist_ij_ven_ij_np_total);
  #variáveis
  rm(meses, n_linhas);
  if(empresa == 16){rm(fat_2018_mes, ng_ij_hist_ij_ven_ij_np_2018_fat)}
}
...
if(teste == F){
  ...
  rm(ax, categoria, fat_tot_categorias, p_ij_n_ij_pp_empresa, p_ij_n_ij_pp_empresa_us, pr_top5_fat, pr_top5_fat_aux,
     ...
     p_ij_n_ij_v_ij_pp, p_ij_n_ij_v_ij_pp_n, negocio_produto, fat_tot_categorias_us, p_ij_n_ij_pp_ij_prod_us,
...
if(teste == F){
  ...
  #variáveis
  if(empresa == 16){rm(aux_3perc, media_empresa_us, n_empresa, n_empresa_us, n_outros_forma, n_total_modo, total_empresa_us)}
}
if (teste == 0) {
  #rm(list=ls())
}
