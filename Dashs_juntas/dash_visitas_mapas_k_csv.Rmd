...
if(teste == F){
  ...
  rm(visita_resultado_empresa, vis_res_emp, vc_ij_vre, vc_ij_vse,
     ...
     vc_ij_vre_ij_v, vc_ij_vre_ij_v_ag, axis_h);
  #variáveis
...
cliente <- fread("Tabelas/cliente.csv", colClasses = c(cliente_id = "character")) %>%
  select (cliente_id, cliente_nome, cliente_latitude, cliente_longitude, cliente_vendedor_id, cliente_empresa_id, cliente_data_cadastro)
#Arrumando encoding
...
if(teste == F){
  #tabelas
  rm(vis_st_emp, cli_ij_vc_mes, cli_ij_vc_ij_ng_mes,
...
if(teste == F){
  #tabelas
  rm( negocio, cli_ij_ng, cli_c_neg_ij_vis_cont, cli_s_neg_ij_vis_cont,
