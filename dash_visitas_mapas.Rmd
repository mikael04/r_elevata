...
pal_t = colorFactor(palette = cores_t, domain = cli_in_pm_cont_top_t_aux$marca_nome)
...
#marcas_icones <-read.csv("Icons/marcas_icon_top6.csv")
...
m1_t <- leaflet(cli_in_pm_cont_top_t_aux) %>%
  addTiles() %>%
  addMarkers(lat = ~lat, lng = ~long, icon = ~iconList(
...
m1_c<- leaflet(cli_in_pm_cont_top_c_aux) %>%
  addTiles() %>%
  addMarkers(lat = ~lat, lng = ~long, icon = ~iconList(
                                                      '1' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/NH_r.png", 23, 24),          ##Caso precise consultar, olhar o csv
                                                      '3' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/CI_r.png", 28, 24),
                                                      '4' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/JD_r.png", 26, 24),
                                                      '5' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/MF_r.png", 34, 24),
                                                      '6' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/agrale_r.png", 34, 24),
                                                      '13' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/jacto_r.png", 24, 24),
                                                      '11' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/valtra_r.png", 95, 24),
                                                      '120191031172113' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/ponsse_r.png", 24, 24),
                                                      '120130518080852' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/valmet_r.png", 26, 24),
                                                      '120120724031949' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/ideal_r.png", 19, 24),
                                                      '120130802084245' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/SLC_r.png", 26, 24),
                                                      '120130522055326' = makeIcon("E:/Mikael/OneDrive/Projetos/Scripts_R/r_elevata/Icons/CBT_r.png", 78, 20)
                                                  )[produto_marca_id],
...
##Adicionando a cor, de "OUTRAS*" -> Na ordem q ela aparece
cores_c <- c("#003E85", "#E64439", '#ACA593',"#39832A", "#FFC500","#808080")
##Preciso fazer os factores de modo automático
...
### Mapa das marcas
```{r}
### Gráfico m1 de distribuição das marcas (top5) de tratores
m1_t
...
```{r}
### Gráfico m2 de distribuição das marcas de tratores
m2_t

```

Mapa das marcas de Colheitadeiras
=======================================================================
...
### Mapa das marcas
```{r}
### Gráfico m1 de distribuição das marcas (top5) de colheitadeiras
m1_c
...
### Distribuição das marcas
```{r}
### Gráfico m2 de distribuição das marcas de colheitadeiras
m2_c
