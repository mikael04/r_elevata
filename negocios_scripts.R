...
### Aqui começa o segundo gráfico que preciso das datas de atualziação (última atualização, por isso o join com historico)
########################################
...
status = c("1 - em negociacao", "2 - montagem de cadastro", "3 - aguardando aprovacao", "4 - financiamento aprovado", "5 - faturado", "6 - financiamento nao aprovado", "7 - desistencia do cliente", "8 - perdemos para concorrencia", "0 - intencao ou prospeccao")
##aqui ele substitui linha a linha cada situação pelo seu respectivo em string
ng_rj_hist_lj_ven$negocio_negocio_situacao_id[ng_rj_hist_lj_ven$negocio_negocio_situacao_id == 1] <- status[1]
ng_rj_hist_lj_ven$negocio_negocio_situacao_id[ng_rj_hist_lj_ven$negocio_negocio_situacao_id == 2] <- status[2]
ng_rj_hist_lj_ven$negocio_negocio_situacao_id[ng_rj_hist_lj_ven$negocio_negocio_situacao_id == 3] <- status[3]
ng_rj_hist_lj_ven$negocio_negocio_situacao_id[ng_rj_hist_lj_ven$negocio_negocio_situacao_id == 8] <- status[4]
ng_rj_hist_lj_ven$negocio_negocio_situacao_id[ng_rj_hist_lj_ven$negocio_negocio_situacao_id == 10] <- status[9]
...
typeof(ng_rj_hist_lj_ven$idade)


ng_rj_hist_lj_ven$idade_cat[ng_rj_hist_lj_ven$idade < 10000]<- idades[5]
ng_rj_hist_lj_ven$idade_cat[ng_rj_hist_lj_ven$idade < 735] <- idades[4]
ng_rj_hist_lj_ven$idade_cat[ng_rj_hist_lj_ven$idade < 366] <- idades[3]
ng_rj_hist_lj_ven$idade_cat[ng_rj_hist_lj_ven$idade < 181] <- idades[2]
ng_rj_hist_lj_ven$idade_cat[ng_rj_hist_lj_ven$idade < 61] <- idades[1]
...
ng_rj_hist_lj_ven_num <- ng_rj_hist_lj_ven %>%
...
ng_rj_hist_lj_emp_num <- ng_rj_hist_lj_ven %>%
