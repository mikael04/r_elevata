#rm(list = ls())
# debug = T
func_tabela_visitas <- function(debug){
  library(data.table)
  library(dplyr)
  ...
  vendedores_empresa <- fct_gera_tabelas_visitas(debug)
  ...
  fct_alt_todas_html('visitas', vendedores_empresa, empresas_ativas, debug)
  #############################################################
}
