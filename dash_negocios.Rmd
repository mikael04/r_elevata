...
Column 
-----------------------------------------------------------------------
### Faturamento dos negócios cadastrados no ano 2020, por vendedor  (Status atual) 
...
### Faturamento de todos os negócios que foram fechados em 2020
...
### Gráfico n13 - Tempo de vida médio de um negócio faturado (status = faturado)
valueBox(ng_cad_fin[1,1], icon = "fa-calendar", color="#32CD32")
```
...
```{r, fig.height=2, fig.width=4}
### Gráfico n13 - Tempo de vida médio de um negócio faturado (status = faturado)
valueBox(ng_cad_fin[2,1], icon = "fa-calendar", color="#FFD700")
...
```{r, fig.height=2, fig.width=4}
### Gráfico n13 - Tempo de vida médio de um negócio faturado (status = faturado)
valueBox(ng_cad_fin[3,1], icon = "fa-calendar", color="#FFA500")
...
```{r, fig.height=2, fig.width=4}
### Gráfico n13 - Tempo de vida médio de um negócio faturado (status = faturado)
valueBox(ng_cad_fin[4,1], icon = "fa-calendar", color="#DE0D26")
