...
##Funil já filtrou (na verdade ng_ij_hist_ij_ven_anat já filtrou) vendedor_a ativo e empresa = 16
...
##Visita precisa juntar com visita_status ou _resultado () pra obter empresa_id ##poderia ser vendedor_a, mas a tabela vis_st_emp (status c/ status_empresa) já está pronta
...
##Negocio precisa juntar com vendedor_a pra obter empresa_id ##Poderia ser cliente também, mas a tabela vendedor_a é menor
##vendedor_a já vem filtrado pela empresa (var global)
ng_ij_emp <- inner_join(negocio, vendedor_a, by = c("negocio_vendedor_id" = "vendedor_id")) %>%
...
##juntando com vendedor_a pra separar por vendedor_a
...
##Agrupando por vendedor_a e por motivo (vc_status_id, depois mostrar so motivo)
...
##Clientes cadastrados por vendedor_a
cli_p_v <- cliente %>%
...
##Juncao pra pegar nome do vendedor_a
...
##Distribuição de clientes total, visita e negócios em anat por vendedor_a
...
##Contar quantos negócios são feitos por vendedor_a em anat
...
##Juncao pra pegar a empresa do negócio (e vendedor_a)
...
### Grafico c0 - Distribuicao de clientes (total), visitas (anat) e negocios (anat) cadastrados por vendedor_a
...
##Clientes cadastrados em anat por vendedor_a
...
-----------------------------------------------------------------------
### Funil do vendedor em valor financeiro, por status do negócio
```{r}
...
### Grafico c0 - Distribuicao de clientes (total), visitas (anat) e negocios (anat) cadastrados por ../Tabelas/
c0
