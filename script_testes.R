...
if(teste == F){
  ...
  rm(ax, categoria, fat_tot_categorias, p_ij_n_ij_pp_empresa, p_ij_n_ij_pp_empresa_us, pr_top5_fat, pr_top5_fat_aux,
     pr_top5_fat_med, proposta_produto, top5_fat, top5_fat_ij_cat, #p_ij_n_ij_v_ij_pp_n,
     p_ij_n_ij_v_ij_pp, p_ij_n_ij_pp_ij_prod, negocio_produto, negocio_aux, fat_tot_categorias_us, p_ij_n_ij_pp_ij_prod_us,
