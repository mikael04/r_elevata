...
n0 <- ggplot(ng_lj_vn_2020, aes(x = reorder(vendedor_nome, desc(vendedor_nome)), num_negocios, fill=factor(negocio_negocio_situacao_id), label = num_negocios)) + #usar o fill pra criar os léveis, ele já ordena por ordem alfabética
...
### Volume de propostas da empresa
...
### Proporção de usados nas propostas
