...
ggplotly(n0) %>%
  layout(legend = list(orientation = "h", x = 0, y = -0.20), textfont = list(size = 4))
...
Column {data-width=350}
-----------------------------------------------------------------------
### Faturamento por tipos de máquina em negociação, por categoria, em 2020
...
Column {data-width=350}
-----------------------------------------------------------------------
### Faturamento por tipos de máquina faturadas, por categoria, em 2020
...
p0 + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
##Se usar ggplot vai pro lugar, se usar o plotly tem q mover como fiz abaixo
ggplotly(p0) %>%
  layout(legend = list(orientation = "h", x = 0, y = -0.25))
##############################################
