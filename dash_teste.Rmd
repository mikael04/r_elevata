...
v0 <- v0 %>%
  layout(barmode = 'stack', xaxis = axis_h, yaxis = axis_h)
if(dash == F){
  v0
}
...
### Faturamento em 2020, 2019 e 2018
...
### Ticket médio das propostas (novos)
...
### Ticket médio das propostas (usados)
...
### Distribuição dos motivos das visitas por vendedor
...
### Distribuição de resultado das visitas por vendedor
