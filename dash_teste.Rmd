...
ng_lj_vn_2020_n$vendedor_nome[ng_lj_vn_2020_n$negocio_vendedor_id == 45] <- "JOÃO PAULO"

##remover status "desconsiderar (erro cadastro)"
ng_lj_vn_2020_n <- ng_lj_vn_2020_n[!(ng_lj_vn_2020_n$negocio_negocio_situacao_id==9),]

##aqui ele transforma os inteiros em chars pra fazermos a alteração
ng_lj_vn_2020_n$negocio_negocio_situacao_id <- as.character(ng_lj_vn_2020_n$negocio_negocio_situacao_id)
...
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 1] <- status[1]
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 2] <- status[2]
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 3] <- status[3]
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 4] <- status[5]
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 5] <- status[6]
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 6] <- status[7]
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 7] <- status[8]
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 8] <- status[4]
ng_lj_vn_2020_n$negocio_negocio_situacao_id[ng_lj_vn_2020_n$negocio_negocio_situacao_id == 10] <- status[9]
...
### Volume de negócios cadastrados por vendedor, ano 2020 (Status atual)

```{r}

##Gráfico do número de clientes por vendedor
##############################################
n0 <- ggplot(ng_lj_vn_2020_n, aes(x = reorder(vendedor_nome, desc(vendedor_nome)), num_negocios, fill=factor(negocio_negocio_situacao_id), label = num_negocios)) + #léveis, ele já ordena por ordem alfabética
...
ggplotly(n0) %>%
  layout(legend = list(orientation = "h", x = -0.4, y = -0.15))
...
```{r}
n3 <- ggplot(ng_f_cn_d_vn, aes(x = reorder(vendedor_nome, desc(vendedor_nome)), num_negocios, fill=factor(negocio_negocio_situacao_id), label = num_negocios)) + #usar o fill pra criar os léveis, ele já ordena por ordem alfabética
  geom_col(position = "stack") +
