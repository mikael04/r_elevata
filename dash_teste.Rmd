...
ng_ij_hist_ij_ven_2020_ij_np_2020 <- inner_join(ng_ij_hist_ij_ven_2020, negocio_produto, by=c("negocio_id" = "np_negocio_id"))
...
ng_ij_hist_ij_ven_2020_ij_np_fec <-  ng_ij_hist_ij_ven_2020_ij_np_2020%>%
...
#ng_ij_hist_ij_ven_2020_ij_np_fec$negocio_negocio_situacao_id[ng_ij_hist_ij_ven_2020_ij_np_fec$negocio_negocio_situacao_id == 4] <- status[5]
#ng_ij_hist_ij_ven_2020_ij_np_fec$negocio_negocio_situacao_id[ng_ij_hist_ij_ven_2020_ij_np_fec$negocio_negocio_situacao_id == 6] <- status[7]
#ng_ij_hist_ij_ven_2020_ij_np_fec$negocio_negocio_situacao_id[ng_ij_hist_ij_ven_2020_ij_np_fec$negocio_negocio_situacao_id == 7] <- status[8]
...
#rm(ng_top10, ng_top10_ag, top10, top10_ij, ng_ij_hist_ij_ven_top10, ng_ij_hist_ij_ven_ij_ngp_ij_pd, ng_ij_hist_ij_ven_ij_ngp_ij_pd_ij_cat)

##Chart gerado para o treemap de categorias por faturamento em 2020
chart_ng_top_ag <- ng_top_ag

##Gráfico 2 - Máquinas negociadas em 2020 (por categoria)
#################################################
...
ng_ij_hist_ij_ven_fec_2020 <- ng_ij_hist_ij_ven_2020_ij_np_2020 %>%
...
prop_ij_neg_cont$proposta_status[prop_ij_neg_cont$proposta_status == 0] <- "0 - Pendente"
prop_ij_neg_cont$proposta_status[prop_ij_neg_cont$proposta_status == 1] <- "1 - Aceito"
prop_ij_neg_cont$proposta_status[prop_ij_neg_cont$proposta_status == 2] <- "2 - Recusado"
prop_ij_neg_cont$proposta_status[prop_ij_neg_cont$proposta_status == 3] <- "3 - Cancelado"
prop_ij_neg_cont$proposta_status[prop_ij_neg_cont$proposta_status == 4] <- "4 - Finalizado"
...
prop_ij_neg_cont_vend$proposta_status[prop_ij_neg_cont_vend$proposta_status == 0] <- "0 - Pendente"
prop_ij_neg_cont_vend$proposta_status[prop_ij_neg_cont_vend$proposta_status == 1] <- "1 - Aceito"
prop_ij_neg_cont_vend$proposta_status[prop_ij_neg_cont_vend$proposta_status == 2] <- "2 - Recusado"
prop_ij_neg_cont_vend$proposta_status[prop_ij_neg_cont_vend$proposta_status == 3] <- "3 - Cancelado"
prop_ij_neg_cont_vend$proposta_status[prop_ij_neg_cont_vend$proposta_status == 4] <- "4 - Finalizado"

##Gráfico 6 - Número propostas, por tipo, por vendedor (total)
p0 <- ggplot(prop_ij_neg_cont_vend, aes(x = reorder(vendedor_nome, desc(vendedor_nome)), cont_status, fill=factor(proposta_status), label = cont_status)) + #usar o fill pra criar os léveis, ele já ordena por ordem alfabética
  geom_col(position = "stack") +
  theme (axis.text.x = element_text(angle = 30, hjust = 1), axis.title = element_blank()) +
...
```{r}
###Gráfico 8 - Funil agrupado por faturamento
n9
```
...
```{r}
##Gráfico 9 - Pizza fechados do ano
n10
```
...
```{r}
##Gráfico 10 -Pizza fechados do mês
n11
```
