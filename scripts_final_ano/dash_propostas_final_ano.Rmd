...
proposta <- fread("Tabelas_final_ano/proposta.csv", colClasses = c(proposta_id = "character", proposta_negocio_id = "character")) %>%
...
proposta_pagamento <- fread("Tabelas_final_ano/proposta_pagamento.csv", colClasses = c(pp_id = "character", pp_proposta_id = "character")) %>%
...
proposta_produto <- fread("Tabelas_final_ano/proposta_produto.csv", colClasses = c(pp_id = "character", pp_proposta_id = "character", pp_produto_id = "character")) %>%
...
negocio_aux <- fread("Tabelas_final_ano/negocio.csv", colClasses = c(negocio_id = "character")) %>%
...
proposta_modo_forma <- fread("Tabelas_final_ano/proposta_modo_forma.csv") %>%
