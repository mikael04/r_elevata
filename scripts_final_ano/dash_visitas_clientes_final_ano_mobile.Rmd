...
visita_resultado <- fread("Tabelas_final_ano/visita_resultado.csv") %>%
...
visita_resultado_empresa <- fread("Tabelas_final_ano/visita_resultado_empresa.csv") %>%
...
Estes dois gráficos visam apresentar a distribuição de clientes agrupados pelo número de visitas para clientes que receberam visitas este ano.
...
### Distribuição dos clientes nas categorias até o final de 2020
