...
-----------------------------------------------------------------------
### Funil da empresa em valor financeiro, por status do negócio (em milhões)
```{r}
### Gráfico n9 - Funil agrupado por faturamento
n9
```
...
### Valor financeiro mês a mês e distribuição do cadastro de clientes, visitas e negócios no ano 2020
